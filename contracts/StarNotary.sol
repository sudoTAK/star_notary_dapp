...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Star Certifier";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "Star exchange failed, you don't own either of the star"
        );

        //beacuse it is not mentioned which token belongs to caller of this method.
